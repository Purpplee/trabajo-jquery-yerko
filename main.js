    ...
    $('#agregar').click(function(){
        ...
        function(data){
            $.each(data, function(i, item){
                ...
                + item.email + "</td><td>" + item.edad + "</td><td><img src=" + item.avatar + "></td><td><button id='borrar' class='borrar' type='button'>eliminar</button>" + "<button type='button' id='modalButton' class='btn btn-primary' data-toggle='modal' data-target='#exampleModal'>info</button>" + "</td></tr>");
            });
